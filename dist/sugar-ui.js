(function (global, factory) {
  ...
  const dialog = {
    ...
    render: function anonymous() {
      ...
      return _ctx_._SUGAR._c('div', {
        'attrs': {},
        'on': {}
      }, [_ctx_.show ? _ctx_._SUGAR._c('div', {
        'attrs': {
          'class': 'sugar-dialog-mode',
          'style': _ctx_.style
        },
        'on': {
          'click': {
        ...
        'attrs': {
          'class': 'sugar-dialog',
          'style': 'transform:' + _ctx_.transform
        },
        'on': {
          'click': {
            'value': 'close',
        ...
        'attrs': {'name': 'default'},
        'on': {}
      }, [])]) : _ctx_._SUGAR._e()]) : _ctx_._SUGAR._e()]);
      ...
      let MessageApp = makeSugar({
        render: function anonymous() {
          ...
          return _ctx_._SUGAR._c('div', {
            ...
            'on': {}
          }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(_ctx_.text))]);
    ...
    bulk(options = {
      ...
      let MessageApp = makeSugar({
        render: function anonymous() {
          ...
          return _ctx_._SUGAR._c('sugar-dialog', {
            'attrs': {'model': _ctx_.show},
            'on': {
              'close': {
                'value': 'cancel',
                'isStatic': undefined,
            ...
            'attrs': {'class': 'sugar-message-box'},
            'on': {}
          }, [_ctx_._SUGAR._c('div', {
            'attrs': {'class': 'sugar-message-title'},
            'on': {}
          }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(_ctx_.title))]), _ctx_._SUGAR._c('div', {
            'attrs': {'class': 'sugar-message-box-content'},
            'on': {}
          }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(_ctx_.content))]), _ctx_._SUGAR._c('div', {
            'attrs': {'class': 'sugar-message-toolbar'},
            'on': {}
          }, [_ctx_._SUGAR._c('div', {
            'attrs': {'class': 'sugar-message-box-btn'},
            'on': {
              'click': {
                'value': 'cancel',
                'isStatic': undefined,
          ...
          }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(_ctx_.cancelText))]), _ctx_._SUGAR._c('div', {
            'attrs': {'class': 'sugar-message-box-btn sugar-message-box-confirm'},
            'on': {
              'click': {
                'value': 'confirm',
                'isStatic': undefined,
          ...
          }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(_ctx_.confirmText))])]), _ctx_._SUGAR._c('div', {
            'attrs': {},
            'on': {}
          }, [])])]);
  ...
  const pageNation = {
    ...
    render: function anonymous() {
      ...
      return _ctx_._SUGAR._c('div', {
        'attrs': {
          'class': 'sugar-pagination',
          'style': _ctx_.style
        },
        'on': {}
      }, [_ctx_._SUGAR._c('ul', {
        'attrs': {'class': 'sugar-pagination__items'},
        'on': {}
      }, [_ctx_.showBtn ? _ctx_._SUGAR._c('li', {
        'attrs': {'class': 'sugar-pagination__item'},
        'on': {
          'click': {
            'value': 'prev',
            'isStatic': undefined,
        ...
        'on': {}
      }, [_ctx_._SUGAR._c('path', {
        'attrs': {
          'd': 'M719.2 912.6c14.2-14.2 14.2-37.2 0-51.4L371.7 513.8c-2.8-2.9-2.8-7.5 0-10.3L719.2 156c14.2-14.2 14.2-37.2 0-51.4-14.2-14.2-37.2-14.2-51.4 0L320.3 452c-15.6 15.6-23.4 36-23.4 56.5s7.8 41 23.4 56.5l347.4 347.4c14.3 14.3 37.3 14.3 51.5 0.2z',
          'fill': _ctx_.canPrev ? '#333' : '#8a8a8a'
        },
        'on': {}
      }, [])])]) : _ctx_._SUGAR._e(), ..._ctx_._SUGAR._loop((item, index) => {
        return _ctx_._SUGAR._c('li', {
          'attrs': {'class': _ctx_.pi === item ? 'sugar-pagination__item sugar-pagination__item--active' : 'sugar-pagination__item'},
          'on': {
            'click': {
              'value': 'changePage',
              'isStatic': undefined,
        ...
        }, [_ctx_._SUGAR._c('button', {
          'attrs': {},
          'on': {}
        }, [_ctx_._SUGAR._v(_ctx_._SUGAR._s(item))])]);
      }, _ctx_.page), _ctx_.showBtn ? _ctx_._SUGAR._c('li', {
        'attrs': {'class': 'sugar-pagination__item right_arrow'},
        'on': {
          'click': {
            'value': 'next',
            'isStatic': undefined,
  ...
  const text = {
    ...
    render: function anonymous() {
      ...
      return _ctx_._SUGAR._c('div', {
        'attrs': {
          'class': 'sugar-text ' + (open ? '' : 'sugar-text__ellipsis'),
          'style': _ctx_.style
        },
        'on': {}
      }, [_ctx_._SUGAR._c('slot', {
        'attrs': {'name': 'default'},
        'on': {}
      }, []), _ctx_.arrow ? _ctx_._SUGAR._c('div', {
        'attrs': {'class': 'sugar-arrow'},
        'on': {
          'click': {
            'value': 'click',
            'isStatic': undefined,
        ...
        attrs: {'class': _ctx_.open ? 'open' : ''},
        on: {}
      }, [_ctx_._SUGAR._html(_ctx_.arrowHtml)])]) : _ctx_._SUGAR._e()]);
    ...
    bulk(ctx) {
      ...
      const [arrow$1, setArrow] = useState(false);
  ...
  const sugarUI = [button, dialog, showMessageBox, showToast, pageNation, BackTop, text, upload];
