...
<svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="100" height="100"><path d="M832 165.76H192c-26.24 0-48 21.76-48 48s21.76 48 48 48h640c26.24 0 48-21.76 48-48s-21.76-48-48-48zM551.04 376.96A58.688 58.688 0 0 0 512 360.32c-12.8 0-29.44 7.04-38.4 16L254.08 595.84c-18.56 18.56-18.56 49.28 0 67.84s49.28 18.56 67.84 0l142.08-142.08v348.16c0 26.24 21.76 48 48 48s48-21.76 48-48V521.6l142.08 142.08c9.6 9.6 21.76 14.08 33.92 14.08s24.32-4.48 33.92-14.08c18.56-18.56 18.56-49.28 0-67.84L551.04 376.96z" p-id="2865" fill="#ffffff"></path></svg>
</div>`,bulk(){const[e,t]=M("");return R(()=>{window.addEventListener("scroll",()=>{400<window.scrollY?t("transform:scale(1)"):t("")})}),{goTop:function(){window.scrollTo({top:0,behavior:"smooth"})},scale:e}}};const{useState:U,onMounted:F,instance:N,nextTick:_,useEffect:O}=SUGAR;var P={name:"sugar-swiper",render:`<div class="sugar-swiper" instance="swiper">
                  <div class="sugar-swiper-wrapper" :style="style">
                        <slot name="default"></slot>
                  </div>
          </div>`,bulk(){const[e,t]=U(""),s=N(),[a,l]=U(""),[n,i]=U("translateX(0)");let r=null,o=0;const[c,u]=U("transform 0.3s"),d=(F(()=>{_(()=>{l(s.value.clientWidth)}),setInterval(()=>{u("transform 0.3s"),o!==s.value.children[0].children.length-1||r?o===s.value.children[0].children.length-1?(r=g(),u("none"),o=0,i(`translateX(-${a.value*o}px)`),_(()=>{u("transform 0.3s"),o=1,i(`translateX(-${a.value*o}px)`)})):o+=1:(r=d(),o+=1,setTimeout(()=>{u("none"),o=0,i(`translateX(-${a.value*o}px)`)},300)),i(`translateX(-${a.value*o}px)`)},2e3)}),()=>{var e,t=s.value.children[0];if(0<t.children.length)return e=t.children[0].cloneNode(!0),t.appendChild(e),e}),g=()=>{var e,t,a=s.value.children[0];if(0<a.children.length)return e=a.children[0].cloneNode(!0),t=a.children[a.children.length-1],a.replaceChild(e,t),e};return O(()=>{t(`width:${a.value*s.value.children[0].children.length}px;transform:${n.value};transition: ${c.value};`)},[a,n]),{style:e,swiper:s}}};const{useState:z,onMounted:C,instance:I,nextTick:X}=SUGAR;var W={name:"sugar-swiper-item",render:`<div class="sugar-swiper-item" :style="'width:'+width" instance="swiper">
                <slot name="default"></slot>
          </div>`,bulk(){const[e,t]=z(""),a=I();return C(()=>{X(()=>{t(a.value.clientWidth+"px")})}),{width:e,swiper:a}}},$=SUGAR["useState"];const[G,j]=$({percentage:{},getPercentage:B,getLoadFinish:function(t){var a={},s=Array.from(document.querySelectorAll("#per_1 [sugar-id]"));for(let e=0;e<s.length;e++)a[s[e].getAttribute("sugar-id")]=B(s[e],t);return a}});function B(e,t){var a=e.getAttribute("sugar-wh").split(",")[0],s=e.getAttribute("sugar-wh").split(",")[1],l=e.getAttribute("sugar-tb").split(",")[0],e=e.getAttribute("sugar-tb").split(",")[1],t=document.querySelector("#"+t),n=t.getAttribute("sugar-wh").split(",")[0],t=t.getAttribute("sugar-wh").split(",")[1];return`width:${(a/n*100).toFixed(2)}%;height:${(s/t*100).toFixed(2)}%;margin-top:${(l/t*100).toFixed(2)}%;margin-bottom:${(e/t*100).toFixed(2)}%`}const{useState:Y,instance:q,onMounted:H}=SUGAR,{useState:V,onMounted:D,instance:J}=SUGAR,E=[{name:"sugar-lazy",render:`<div instance="node">
                 <slot name="default" s-if="show" ></slot>
           </div>`,bulk(e){const[t,a]=V(!1),s=J();return D(()=>{console.log(s.value),window.addEventListener("scroll",()=>{s.value.getBoundingClientRect().top<window.innerHeight&&a(!0)})}),{show:t,node:s}}},{name:"sugar-percentage",render:`<div style="width:100%;height:100%%;position:relative" :id="id" :sugar-wh="sugarWh">
          ...
          </div>`,bulk(e){var[t,,]=Y(""),a=q();return G.value.percentage[e.id.value]||j(Object.assign(Object.assign({},G.value),{percentage:Object.assign(Object.assign({},G.value.percentage),{[e.id.value]:{id:e.id.value}})})),H(()=>{j(Object.assign(Object.assign({},G.value),{percentage:Object.assign(Object.assign({},G.value.percentage),{[e.id.value]:{id:e.id.value}})}))}),{style:t,background:e.background,id:e.id,bg:a,sugarWh:e["sugar-wh"]}}},t,a,n,c,u,f,w,A,{name:"sugar-message",render:"",bulk(e){return{}}},T,L,P,W];"undefined"!=typeof window&&(($=window).sugarUI=E,$.sugarStore=G,$.getLoadFinish=G.value.getLoadFinish),e.store=G,e.sugarUI=E});
