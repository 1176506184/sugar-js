        ...
        <div class="layout_viewer" id="layout_viewer">
            ...
            <div id="menu" v-if="state.isLogin">
                ...
                <div style="display: flex">
                    <el-input placeholder="最大采集文章数" style="width: 140px;margin-right: 15px;"
                              v-model="toutiaoMax"></el-input>
                    <el-button type="primary" @click="collectToutiao" v-if="toutiaoPending!=='start'">开始采集</el-button>
                    <el-button type="danger" @click="stopCollectToutiao" v-else>停止采集</el-button>
                </div>
                <div class="border"></div>
                <!--        <p>脸书社团</p>-->
                <!--        <div>-->
...
<script setup>
    ...
    const eventBus = function (Message, sender, sendResponse) {
        if (Message.Message === 'callbackData') {
            ...
            data = data.map(d => {
                return {
                    resource_url: d.entities?.media?.map(e => {
        ...
        chrome.tabs.query({
            ...
            chrome.tabs.sendMessage(tabs[0].id, {
                ...
                if (response?.state !== 200) {
                    ...
                    console.log(toutiaoPending.value)
                }
            });
        });
    }
