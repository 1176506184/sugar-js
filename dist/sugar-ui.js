!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports):"function"==typeof define&&define.amd?define(["exports"],t):t((e="undefined"!=typeof globalThis?globalThis:e||self).Sugar={})}(this,function(e){"use strict";const{useEffect:v,useState:g}=SUGAR,t={name:"sugar-dialog",render:`<div>
        <div class="sugar-dialog-mode" :style="style" s-if="show" @click.self="close">
            <div class="sugar-dialog" s-if="show" @click.self="close" :style="'transform:' + transform">
...
</div>`,bulk(e){var t;const[a,l]=g(!1),[s,n]=g(0),i=null!=(t=null==(t=e.direction)?void 0:t.value)?t:"center",[o,r]=g(""),[u,c]=g(d(i));function d(e,t=!1){return"center"!==e&&"top"===e?t?"translateY(0)":"translateY(-100%)":""}return v(()=>{e.model.value?(l(!0),setTimeout(()=>{n(1)},50)):(n(0),setTimeout(()=>{e.model.value||l(!1)},300)),r(`opacity:${s.value};`),a.value?setTimeout(()=>{c(d(i,a.value))},50):c(d(i,a.value))},[e.model,s,a],!0),{show:a,close:function(){e.close()},opacity:s,style:o,transform:u}}},s=SUGAR["useState"];var a={name:"sugar-button",render:`<button class="sugar-button" style="margin: 5px 5px 0;" @click="click">
                    <slot name="default"></slot>
                ...
                <img :src="ctx.src"/>
          </div>`,bulk(e){var[t,,]=l("sugar-image-container");return{ctx:e,className:t}}};const{useEffect:i,useState:o,onMounted:r}=SUGAR;var u={name:"sugar-checkbox",render:`
    <div class="sugar-checkbox-container" :style="style" @click.self="click">
     <div class="sugar-checked" s-if="checked" ></div>
    </div>
  `,bulk(e){r(()=>{console.log(e)});const[t,a]=o(!1);var[l,,]=o("");return i(()=>{a(e.model.value)},[e.model],!0),{checked:t,ctx:e,style:l,click:function(){console.log(e)}}}};const{useEffect:b,useState:x}=SUGAR;var c={name:"sugar-pagination",render:`
  ...
  `,bulk(t){const[e,a]=x(1),[l,s]=x(20),[n,i]=x(0),[o,r]=x([1]),[u,c]=x(!1),[d,v]=x(!1),[g,h]=x(!1),[f,p]=x(!1),[,m]=x(!1);function w(){s(t.ps.value),a(t.pi.value),i(t.total.value),r(function(t,a,l){t=Number(t),a=Number(a),l=Number(l);var s=[];for(let e=1;e<=a;e++){var n=t-e;0<n&&s.unshift(n)}var i=[];for(let e=1;e<=a+(a-s.length);e++){var o=t+e;o<=l&&i.push(o)}if(i.length<a){var r=s.length;for(let e=1;e<=a-i.length;e++){var u=t-r-e;0<u&&s.unshift(u)}}return[...s,t,...i]}(e.value,t.page.value,Math.ceil(n.value/l.value))),t["show-sis"]&&m(t["show-sis"].value),1<e.value?v(!0):v(!1),e.value<Math.ceil(n.value/l.value)?c(!0):c(!1),t.btn&&h(t.btn.value),t["show-most"]&&p(t["show-most"].value),f.value&&!o.value.includes(1)&&r([1,...o.value]),f.value&&!o.value.includes(Math.ceil(n.value/l.value))&&r([...o.value,Math.ceil(n.value/l.value)])}return w(),b(()=>{w()},[t.ps,t.pi,t.total,t.btn,t.page,t["show-most"],t["show-sis"]],!0),{pi:e,setPi:a,ps:l,setPs:s,total:n,page:o,style:t.style,canNext:u,canPrev:d,changePage:function(e){t.change(e)},showBtn:g,prev:function(){1<e.value&&t.change(e.value-1)},next:function(){e.value<Math.ceil(n.value/l.value)&&t.change(e.value+1)}}}};const d={let:"transform: rotate(180deg);",right:"transform: rotate(0deg);",top:"transform: rotate(90deg);",bottom:"transform: rotate(-90deg);"},{useEffect:h,useState:f}=SUGAR;var p={name:"sugar-text",render:`<div :class="'sugar-text ' + (open ? '':'sugar-text__ellipsis')" :style="style">
                <slot name="default"></slot>
           ...
           </div>`,bulk(t){const a=m();return{fileInput:function(e){t.change(e.target.files),a.value.value=""},fileRef:a,uploadFile:function(){a.value.click()}}}};const{makeSugar:k,useState:y,onMounted:S}=SUGAR;var A={fun:"showToast",bulk(e,t=2e3,a=""){let l=document.createElement("div"),s=(document.body.appendChild(l),k({render:'<div class="sugar-toast" :style="style">{{text}}</div>',bulk(){return{text:e,style:a}}}));s.mount(l),setTimeout(()=>{s=null,l.remove(),l=null},t)}},R={fun:"showMessageBox",bulk(l={title:"提示",content:"这是一条提示的内容",confirmText:"确认",cancelText:"取消",confirm:()=>{},cancel:()=>{}}){let s=document.createElement("div"),n=(document.body.appendChild(s),k({render:`<sugar-dialog :model="show" @close="cancel">
...
<svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="100" height="100"><path d="M832 165.76H192c-26.24 0-48 21.76-48 48s21.76 48 48 48h640c26.24 0 48-21.76 48-48s-21.76-48-48-48zM551.04 376.96A58.688 58.688 0 0 0 512 360.32c-12.8 0-29.44 7.04-38.4 16L254.08 595.84c-18.56 18.56-18.56 49.28 0 67.84s49.28 18.56 67.84 0l142.08-142.08v348.16c0 26.24 21.76 48 48 48s48-21.76 48-48V521.6l142.08 142.08c9.6 9.6 21.76 14.08 33.92 14.08s24.32-4.48 33.92-14.08c18.56-18.56 18.56-49.28 0-67.84L551.04 376.96z" p-id="2865" fill="#ffffff"></path></svg>
</div>`,bulk(){const[e,t]=T("");return B(()=>{window.addEventListener("scroll",()=>{400<window.scrollY?t("transform:scale(1)"):t("")})}),{goTop:function(){window.scrollTo({top:0,behavior:"smooth"})},scale:e}}};const{useState:M,onMounted:O,instance:I,nextTick:L,useEffect:P}=SUGAR;var z={name:"sugar-swiper",render:`<div class="sugar-swiper" instance="swiper">
                  <div class="sugar-swiper-wrapper" :style="style">
                        <slot name="default"></slot>
                  </div>
          </div>`,bulk(){const[e,t]=M(""),l=I(),[a,s]=M(""),[n,i]=M("translateX(0)");let o=null,r=0;const[u,c]=M("transform 0.3s"),d=(O(()=>{L(()=>{s(l.value.clientWidth)}),setInterval(()=>{c("transform 0.3s"),r!==l.value.children[0].children.length-1||o?r===l.value.children[0].children.length-1?(o=v(),c("none"),r=0,i(`translateX(-${a.value*r}px)`),L(()=>{c("transform 0.3s"),r=1,i(`translateX(-${a.value*r}px)`)})):r+=1:(o=d(),r+=1,setTimeout(()=>{c("none"),r=0,i(`translateX(-${a.value*r}px)`)},300)),i(`translateX(-${a.value*r}px)`)},2e3)}),()=>{var e,t=l.value.children[0];if(0<t.children.length)return e=t.children[0].cloneNode(!0),t.appendChild(e),e}),v=()=>{var e,t,a=l.value.children[0];if(0<a.children.length)return e=a.children[0].cloneNode(!0),t=a.children[a.children.length-1],a.replaceChild(e,t),e};return P(()=>{t(`width:${a.value*l.value.children[0].children.length}px;transform:${n.value};transition: ${u.value};`)},[a,n]),{style:e,swiper:l}}};const{useState:C,onMounted:X,instance:W,nextTick:Y}=SUGAR;var q={name:"sugar-swiper-item",render:`<div class="sugar-swiper-item" :style="'width:'+width" instance="swiper">
                <slot name="default"></slot>
          </div>`,bulk(){const[e,t]=C(""),a=W();return X(()=>{Y(()=>{t(a.value.clientWidth+"px")})}),{width:e,swiper:a}}},U=SUGAR["useState"];const[G,_]=U({percentage:{},getPercentage:$,getLoadFinish:function(t){var a={},l=Array.from(document.querySelectorAll("#per_1 [sugar-id]"));for(let e=0;e<l.length;e++)a[l[e].getAttribute("sugar-id")]=$(l[e],t);return a}});function $(e,t){var a=e.getAttribute("sugar-wh").split(",")[0],l=e.getAttribute("sugar-wh").split(",")[1],s=e.getAttribute("sugar-tb").split(",")[0],e=e.getAttribute("sugar-tb").split(",")[1],t=document.querySelector("#"+t),n=t.getAttribute("sugar-wh").split(",")[0],t=t.getAttribute("sugar-wh").split(",")[1];return`width:${(a/n*100).toFixed(2)}%;height:${(l/t*100).toFixed(2)}%;margin-top:${(s/t*100).toFixed(2)}%;margin-bottom:${(e/t*100).toFixed(2)}%`}const{useState:H,instance:V,onMounted:D}=SUGAR,{useState:J,onMounted:K,instance:Q}=SUGAR,{useState:F,onMounted:Z,instance:E}=SUGAR,{useState:ee,onMounted:te,instance:ae,useEffect:le}=SUGAR,j=[{name:"sugar-picker",render:`<div>
          ...
          </div>`,bulk(t){var e,a=(null==(a=t.label)?void 0:a.value)||"文本",l=(null==(l=t.placeholder)?void 0:l.value)||"请输入";const s=E(),n=E(),[i,o]=F(!0),[r,u]=F(!0),[c,d]=F((null==(e=t.value)?void 0:e.value)||"");return Z(()=>{var e;0<(null==(e=s.value)?void 0:e.children.length)&&o(!1),0<(null==(e=n.value)?void 0:e.children.length)&&u(!1)}),{label:a,labelRef:s,showLabel:i,defaultRef:n,placeholder:l,showField:r,input:t.input,value:c,onInput:function(e){d(e.target.value),t.input(e.target.value)}}}},{name:"sugar-lazy",render:`<div instance="node">
          ...
          </div>`,bulk(e){var[t,,]=H(""),a=V();return G.value.percentage[e.id.value]||_(Object.assign(Object.assign({},G.value),{percentage:Object.assign(Object.assign({},G.value.percentage),{[e.id.value]:{id:e.id.value}})})),D(()=>{_(Object.assign(Object.assign({},G.value),{percentage:Object.assign(Object.assign({},G.value.percentage),{[e.id.value]:{id:e.id.value}})}))}),{style:t,background:e.background,id:e.id,bg:a,sugarWh:e["sugar-wh"]}}},t,a,n,u,c,p,w,A,{name:"sugar-message",render:"",bulk(e){return{}}},R,N,z,q];"undefined"!=typeof window&&((U=window).sugarUI=j,U.sugarStore=G,U.getLoadFinish=G.value.getLoadFinish),e.store=G,e.sugarUI=j});
